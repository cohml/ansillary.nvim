describe("ansillary.config", function()
  ...
  describe("default configuration", function()
    it("should have correct default values", function()
      ...
      assert.are.equal(true, config.reveal_under_cursor)
  ...
  describe("boolean configuration values", function()
    ...
    it("should have boolean type for reveal_under_cursor", function()
      assert.is_boolean(config.reveal_under_cursor)
    end)
